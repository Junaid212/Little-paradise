...
<div className="ltn__property-details-gallery mb-30" id='responsive-text-project-title'>
                        <div className="row">
                            ...
                            <a>
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Lounge/l1.jpg"} alt="Image" /> */}
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/maz/maz2.jpg"} alt="Image" /> */}
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Lounge/l2.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Lounge/l3.webp"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Lounge/l4.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Lounge/l5.jpg"} alt="Image" />
