...
class RollsPage extends Component {
...
<div className="ltn__property-details-gallery mb-30" id='responsive-text-project-title'>
                        <div className="row">
                            ...
                            <a>
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c1.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c2.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c3.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c4.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c5.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c6.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c7.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c8.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c9.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c10.jpg"} alt="Image" />
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/rolls/c2.jpg"} alt="Image" /> */}
                            </a>
