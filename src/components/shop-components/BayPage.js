...
class BayPage extends Component {
...
<div className="ltn__property-details-gallery mb-30" id='responsive-text-project-title'>
                        <div className="row">
                            ...
                            <a>
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Bay/b1.jpg"} alt="Image" />
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/maz/maz2.jpg"} alt="Image" /> */}
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/maz/maz3.jpg"} alt="Image" /> */}
