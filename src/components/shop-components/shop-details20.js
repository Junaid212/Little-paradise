...
class ShopDetails20 extends Component {
    ...
    return <div className="ltn__shop-details-area pb-10">
				...
				<div className="row">
					...
					<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
					 ...
					 <h4 className="title-2"  id='responsive-text-project-heading'>Interior for a young family of 3
</h4>
...
<div className="row">
	...
	<img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture65.webp"} alt="Image" />

    </div>
    <div className="col-md-6">
	<img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture66.webp"} alt="Image" />

    </div>
   
</div>
</div>
<p   id='responsive-text-project-title'>The brief required the interiors to have positive energy while mirroring the colorful personality of our client. He wanted us to experiment with colors while keeping it tasteful. We tried to keep a cool toned neutral palette with a contrast of pop of color in every space while there is something that connects the entire space as well.
...
<div className="row">
	...
	<img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture68.webp"} alt="Image" />
    </div>
    <div className="col-md-6">
   
	<img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture67.webp"} alt="Image" />
    </div>
    <div className="col-md-6">
   
	<img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture69.webp"} alt="Image" />
    </div>
    <div className="col-md-6">
   
	<img  src={publicUrl+"assets/img/Allimgs/Picture70.webp"} alt="Image" />
    </div>
                        ...
                        <div className="col-md-5" id="responsive-text-project-heading">
							{/* <a href={publicUrl+"assets/img/Allimgs/Picture67.webp"} data-rel="lightcase:myCollection"> */}
								{/* <img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture67.webp"} alt="Image" /> */}
							{/* </a> */}
                        ...
                        <div className="col-md-5">
							{/* <a href={publicUrl+"assets/img/Allimgs/Picture68.webp"} data-rel="lightcase:myCollection"> */}
								{/* <img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture68.webp"} alt="Image" /> */}
							{/* </a> */}
                        ...
                        <div className="col-md-12" id="responsive-text-project-heading">
							{/* <a href={publicUrl+"assets/img/Allimgs/Picture69.webp"} data-rel="lightcase:myCollection"> */}
								{/* <img className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture69.webp"} alt="Image" /> */}
							{/* </a> */}
                            ...
                            <div className="col-md-12" id="responsive-text-project-heading">
							{/* <a href={publicUrl+"assets/img/Allimgs/Picture70.webp"} data-rel="lightcase:myCollection"> */}
								{/* <img  className="mb-30" src={publicUrl+"assets/img/Allimgs/Picture70.webp"} alt="Image" /> */}
							{/* </a> */}
