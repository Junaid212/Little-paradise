...
class RevaPage extends Component {
...
<div className="ltn__property-details-gallery mb-30" id='responsive-text-project-title'>
                        <div className="row">
                            ...
                            <a>
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/reva/r2.jpg"} alt="Image" />
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/maz/maz2.jpg"} alt="Image" /> */}
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/reva/r3.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/reva/r4.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/reva/r5.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/reva/r6.webp"} alt="Image" />
