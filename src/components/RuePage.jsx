...
class RuePage extends Component {
				...
				<div className="row">
					...
					<div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
					 ...
					 ><span className="ltn__secondary-color"><img src='assets/img/Allimgs/pin.png' /></span> Downtown, Dubai, United Arab Emirates</label> 
                        ...
                        <p id='responsive-text-project-title'>Studio Apartment Interior Design in Dubai
                        </p>
                        <p id='responsive-text-project-title'>This modern studio apartment interior design in Dubai features a neutral color palette, cozy textures, and smart storage solutions. Designed for compact urban living, it blends comfort and functionality with sleek finishes and warm lighting offering a stylish, space-efficient solution for contemporary city lifestyles.
                        </p>
...
<p  id='responsive-text-project-title'>The vision of the eyewear brand was to bring dynamic eyewear designs that are not just for the present but the future too. 
						...
						<div className="col-md-12" style={{display:'flex',justifyContent:'center'}}>
							{/* <a href={publicUrl+"assets/img/Allimgs/Picture90.webp"} data-rel="lightcase:myCollection"> */}
								<img className="mb-30" src={publicUrl+"assets/img/updatates/project/rue1.jpg"} alt="Image" />
							{/* </a> */}
...
<div className="row">
	...
	{/* <a href={publicUrl+"assets/img/Allimgs/Picture94.webp"} data-rel="lightcase:myCollection"> */}
								<img className="mb-30" src={publicUrl+"assets/img/updatates/project/rue2.jpg"} alt="Image" />
							{/* </a> */}
	...
	{/* <a href={publicUrl+"assets/img/Allimgs/Picture93.webp"} data-rel="lightcase:myCollection"> */}
								<img className="mb-30" src={publicUrl+"assets/img/updatates/project/rue3.jpg"} alt="Image" />
							{/* </a> */}
	...
	{/* <a href={publicUrl+"assets/img/Allimgs/Picture92.webp"} data-rel="lightcase:myCollection"> */}
								<img className="mb-30" src={publicUrl+"assets/img/updatates/project/rue4.jpg"} alt="Image" />
							{/* </a> */}
